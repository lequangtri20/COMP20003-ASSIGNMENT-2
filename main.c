...
*		2. Type "./map1 input_file output_file < query_file" into the terminal
* 		(names of 3 files are flexible depending on command line arguments).

===========================MAIN FUNCTION FOR MAP1 ============================*/
...
int main(int argc, char **argv){
	...
	/* Read query and find the closest point to given coordinates */
	read_query(fout, kd_tree);
